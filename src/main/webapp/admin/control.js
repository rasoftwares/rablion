...
adminApp.controller('paymentCtrl', ['$scope', '$http', function ($scope, $http) {
   $http({
	      method: 'GET',
	    	  url: payment_URL,
	    	}).then(function successCallback(response) {
...
adminApp.controller('discountCtrl', ['$scope', '$http', function ($scope, $http) {
   $http({
	      method: 'GET',
	    	  url: discount_URL,
	    	}).then(function successCallback(response) {
...
adminApp.controller('customerCtrl', ['$scope', '$http', function ($scope, $http) {
   $http({
	      method: 'GET',
	    	  url: customer_URL,
	    	}).then(function successCallback(response) {
